    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('maker', models.ForeignKey(to='modelphone.Maker')),
            ],
        ),
        migrations.CreateModel(
            name='PPhoto',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('nicename', models.CharField(default=b'\xe8\xb6\x85\xe5\x80\xbc\xe4\xba\x8c\xe6\x89\x8b\xe6\x89\x8b\xe6\x9c\xba', max_length=15)),
                ...
                ('pmodel', models.ForeignKey(to='modelphone.PModel')),
            ],
        ),
        migrations.AddField(
            model_name='pphoto',
            name='product',
            field=models.ForeignKey(to='modelphone.Product'),
        ),
    ]
